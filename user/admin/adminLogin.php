  ...
  <div id="header">
    ...
    <div id="topnav">
      <ul>
        ...
        <li ><a href="#">Add User Account</a></li>
      ...
      <div class="subnav">
        ...
        <ul>
		  <li><a><B>Post Notice</B></a>
		    <ul>
              <li><a href="#">Post new notice</a></li>
              <li><a href="#">Edit/delete notice</a></li>
            </ul>
		  </li>
          <li><a><B>Student</B></a>
			<ul>
              <li><a href="#">Add new student</a></li>
              <li><a href="#">Edit student info</a></li>
			  <li><a href="#">Class, Subject & Result</a></li>
          ...
          <li><a><B>Teacher</B></a>
            <ul>
              ...
              <li><a href="#">Edit teacher info</a></li>
			  <li><a href="#">Assign Class & Subject</a></li>
            </ul>
          </li>
         <li><a><B>Parent</B></a>
            <ul>
              <li><a href="#">Add new parent</a></li>
              <li><a href="#">Edit parent info</a></li>
            </ul>
          </li>
		  <li><a><B>Class & Subject</B></a>
            <ul>
              <li><a href="#">Set class & Subject</a></li>
              <li><a href="#">Edit class & Subject</a></li>
            </ul>
          </li>
        </ul>
      </div>
