...
<div class="wrapper col2">
  <div id="featured_slide">
    <div class="featured_box"><a href="#"><img src="images/home/school.jpg" alt="" /></a>
      <div class="floater">
        <h2>1. School</h2>
    ...
    <div class="featured_box"><a href="#"><img src="images/home/classroom.jpg" alt="" /></a>
      <div class="floater">
        <h2>2. Classrooms</h2>
    ...
    <div class="featured_box"><a href="#"><img src="images/home/comlab.jpg" alt="" /></a>
      <div class="floater">
    ...
    <div class="featured_box"><a href="#"><img src="images/home/library.jpg" alt="" /></a>
      <div class="floater">
    ...
    <div class="featured_box"><a href="#"><img src="images/home/auditorium.jpg" alt="" /></a>
      <div class="floater">
        <h2>5. Auditorium</h2>
		...
		if($count<7)
		{
			...
			{?>
				...
				{?>
					...
					<div class="imgholder"><a href="#"><img src="images/home/picnic.jpg" alt="" /></a></div>
				<?php}
				elseif($row[3]==="Date")
				{?>
					<div class="imgholder"><a href="#"><img src="images/home/put.png" alt="" /></a></div>
				
				<?php}
				elseif($row[3]==="New Rule")
				{?>
					<div class="imgholder"><a href="#"><img src="images/home/teacher.png" alt="" /></a></div>
				
				<?php}
				elseif($row[3]==="School Off")
				{?>
					<div class="imgholder"><a href="#"><img src="images/home/springbreak.jpg" alt="" /></a></div>
				
				<?php}
				elseif($row[3]==="volunteer")
				{?>
					<div class="imgholder"><a href="#"><img src="images/home/volunteer.jpg" alt="" /></a></div>
				
				<?php}
				elseif($row[3]==="Sports")
				{?>
				
					<div class="imgholder"><a href="#"><img src="images/home/sport.jpg" alt="" /></a></div>
				
				<?php}
				elseif($row[3]==="File" or "Else")
				{?>
				
					<div class="imgholder"><a href="#"><img src="images/home/file.jpg" alt="" /></a></div>
				
				<?php }?>   -->
				<!-- <div class="imgholder"><a href="#"><img src="images/home/picnic.jpg" alt="" /></a></div> -->
				<p><strong><a href="#"><?php echo $row[1] ?></a></strong></p>
				<p><?php echo $row[2] ?></p>
